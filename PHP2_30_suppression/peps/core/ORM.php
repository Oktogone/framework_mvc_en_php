 ...
 * Implémente JsonSerializable pour préciser les propriétés non PUBLIC à sérialiser non sérialisées par défaut.
 */
abstract class ORM implements JsonSerializable
{
	 ...
	 * Par défaut, seules les propriétés PUBLIC sont sérialisées.
