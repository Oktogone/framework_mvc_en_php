...
final class Router
{
	 ...
	 * @throws RouterException Si $params comporte une clé 'view' ou 'params' (paramètres reçus), ou si la vue demandée est introuvable.
	 */
	public static function render(string $view, array $params = []): never
	{
		exit($view); //TEMP pour avoir une indication.
	}
}
